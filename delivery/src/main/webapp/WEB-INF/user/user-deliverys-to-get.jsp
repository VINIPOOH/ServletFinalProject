...
<div name="deliveries-which-wait-getting" class="container">
    ...
    <div class="row border border-info mt-2 rounded">
        ...
        <p1 class="list-group-item"><fmt:message key="user-deliverys-to-get.card.list.to.city"/>${deliveryForUser.localityGetName}</p1>
        </div>
        <div class="card-body col-md-2">
            <form class="form" method="post" action="${pageContext.request.contextPath}/user/delivers-to-get">
