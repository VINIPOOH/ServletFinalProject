...
public class JDBCBillTransactionalDao extends JDBCAbstractGenericDao<Bill> implements BillDao {
    ...
    public JDBCBillTransactionalDao(ResourceBundle resourceBundleRequests, DbConnectionPoolHolder connector) {
