...
public class WrappedTransactionalConnectionPoolImplTest {

    @InjectMocks
    WrappedTransactionalConnectionPoolImpl transactionalConnectionPool;
    ...
    public void getConnectionAdapter() throws SQLException {
        ...
        ConnectionAdapeter result = transactionalConnectionPool.getConnectionAdapter();
    ...
    public void getConnectionAdapterPreparedForTransaction() throws SQLException, NoSuchFieldException, IllegalAccessException {
        ...
        ConnectionAdapeter result = transactionalConnectionPool.getConnectionAdapterPreparedForTransaction();
