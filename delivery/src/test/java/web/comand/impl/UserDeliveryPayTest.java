...
public class UserDeliveryPayTest {

    @InjectMocks
    UserDeliveryPay userDeliveryPay;
    @Mock
    ...
    public void performGet() {
        ...
        assertEquals(MAIN_WEB_FOLDER + USER_FOLDER + USER_DELIVERY_CONFIRM_DELIVERY_FILE_NAME, actual);
    }
